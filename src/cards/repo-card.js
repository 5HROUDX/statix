...
const renderRepoCard = (repo, options = {}) => {
  ...
  card.setCSS(`
    .description { font: 400 13px 'monospace', Shroud Serif, Sans-Serif; fill: ${colors.textColor} }
    .gray { font: 400 12px 'monospace', Shroud Serif, Sans-Serif; fill: ${colors.textColor} }
    .icon { fill: ${colors.iconColor} }
    .badge { font: 600 11px 'monospace', Shroud Serif, Sans-Serif; }
